...
export function PriceEditPanel({
    ...
    getBookingPreview({
      ...
      .catch(() => {
        ...
        getPetBenefitsSummary(booking.pet_id)
          ...
          .catch(() => { /* Benefits genuinely unavailable */ });
      })
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [editBenefitIds, editServicePrice, editServiceDiscount, editServiceDiscountType, editTravelFee, editTravelFeeDiscount, editTravelFeeDiscountType, editAddonPrices, editAddonDiscounts, editAddonDiscountTypes]);
  ...
  useEffect(() => {
    ...
    return () => { cancelled = true; };
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [editPromotionIds, editServicePrice, editTravelFee, editAddonPrices, pricePreviewData]);
      ...
      <div>
        ...
        <div className="flex flex-col gap-2">
          ...
          {(() => {
            ...
            return (
              <ItemPriceEditor
                label={booking.service_snapshot.name}
                ...
                onDiscountTypeChange={(t) => { setEditServiceDiscountType(t); setEditServiceDiscount(""); }}
          ...
          {(booking.pick_up || booking.delivery || booking.type === "in home") && (() => {
            ...
            return (
              <ItemPriceEditor
                label={feeLabel}
                labelIcon={<Truck className="h-3.5 w-3.5 shrink-0 text-muted-foreground" />}
                ...
                onDiscountTypeChange={(t) => { setEditTravelFeeDiscountType(t); setEditTravelFeeDiscount(""); }}
    ...
    <div className="flex flex-col gap-1.5 rounded-lg border border-border/50 bg-card p-3">
      ...
      <div className="flex items-end gap-2">
        ...
        <div className="flex flex-1 flex-col gap-1">
          ...
          <div className="flex gap-1">
            ...
            <div className="flex h-8 shrink-0 overflow-hidden rounded-md border border-border">
              <button type="button" onClick={() => onDiscountTypeChange("nominal")}
              ...
              <button type="button" onClick={() => onDiscountTypeChange("pct")}
        ...
        <div className="flex flex-col items-end gap-1">
          ...
          <span className="mb-0.5 text-sm font-semibold text-primary">{formatPrice(effectivePrice)}</span>
        </div>
      </div>
    </div>
  );
