...
export const bookings: Booking[] = [
  ...
  },
  {
    ...
    petId: "pet-1",
    petName: "Buddy",
    requestNotes: "Tolong pakai shampoo yang lembut dan hypoallergenic ya",
    status: "confirmed",
    jobStatus: "pending",
    serviceId: "svc-2",
    serviceName: "Full Grooming",
    addOnIds: ["addon-8", "addon-10"],
    addOnNames: ["Face & Eye Trimming", "Paw Balm Treatment"],
    preConditions: [],
    groomerId: "groomer-1",
    groomerName: "Sarah Miller",
    travelFee: 0,
  ...
  },
  {
    ...
    serviceName: "Basic Grooming",
    addOnIds: ["addon-5"],
    addOnNames: ["Whitening Shampoo"],
    preConditions: [
      {
        id: "pc-2",
        description: "Bulu di bagian punggung agak kusut, sedang dalam proses detangling",
        flaggedBy: "Sarah Miller",
        flaggedAt: "2026-02-20T13:10:00",
      },
    ],
    groomerId: "groomer-1",
    groomerName: "Sarah Miller",
    ...
    media: [
      {
        id: "media-4",
        url: "https://images.unsplash.com/photo-1548199973-03cce0bbc87b?w=400&h=400&fit=crop&auto=format",
        type: "before",
        uploadedAt: "2026-02-20T13:05:00",
      },
    ],
  ...
  },
  {
    ...
    petId: "pet-1",
    petName: "Buddy",
    requestNotes: "Groomer datang ke rumah pagi sebelum jam 10",
    status: "completed",
    jobStatus: "finished",
    serviceId: "svc-4",
    serviceName: "Home Grooming – Full Service",
    addOnIds: ["addon-7", "addon-11"],
    addOnNames: ["Basic Care Upgrade", "Flea Tick Spray"],
    preConditions: [],
    groomerId: "groomer-2",
    groomerName: "Jake Thompson",
    travelFee: 75000,
    media: [
      {
        id: "media-5",
        url: "https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=400&h=400&fit=crop&auto=format",
        type: "before",
        uploadedAt: "2026-01-28T09:05:00",
      },
      {
        id: "media-6",
        url: "https://images.unsplash.com/photo-1548199973-03cce0bbc87b?w=400&h=400&fit=crop&auto=format",
        type: "after",
        uploadedAt: "2026-01-28T10:25:00",
      },
    ],
