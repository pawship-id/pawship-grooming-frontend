...
export async function getMemberships(params: GetMembershipsParams = {}) {
  ...
  return apiAuthRequest<MembershipsResponse>(`/memberships${qs ? `?${qs}` : ""}`)
}
...
export async function purchasePetMembership(payload: PurchasePetMembershipPayload) {
...
export async function getPetMembershipBenefitsSummary(petId: string) {
  return apiAuthRequest<BenefitsSummaryResponse>(`/pet-memberships/${petId}/benefits-summary`)
}
...
export async function updatePetMembership(id: string, payload: UpdatePetMembershipPayload) {
  return apiAuthRequest<PetMembershipDetailResponse>(`/pet-memberships/${id}`, {
    method: "PUT",
    body: JSON.stringify(payload),
  })
